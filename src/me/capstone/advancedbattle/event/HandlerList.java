...
public final class HandlerList {
	...
	/**
	 * Returns the Dynamic handler lists. These are changed using register() and unregister(). Changes automatically baked to the handlers array any time they have changed..
	 */
